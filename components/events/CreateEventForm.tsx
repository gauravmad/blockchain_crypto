...
const formSchema = z.object({
  ...
  ticketSupply: z.string().min(1, {
    message: "Ticket supply is required.",
  }),
  maxPerWallet: z.string().min(1, {
    message: "Maximum tickets per wallet is required.",
  }),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Web3 Conference 2025" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Provide a URL to an image (1200x630px recommended)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Allow ticket holders to transfer tickets to other wallets
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
